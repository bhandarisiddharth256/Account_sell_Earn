import { ArrowDownCircleIcon, BanIcon, CheckCircle, Clock, CoinsIcon, DollarSign, DollarSignIcon, Edit, Eye, EyeIcon, EyeOffIcon, LockIcon, Plus, StarIcon, TrashIcon, TrendingUp, TrendingUpIcon, Users, WalletIcon, XCircle } from 'lucide-react';
import React, { useState } from 'react'
import { useSelector } from 'react-redux'
import { useNavigate } from 'react-router-dom';
import StatCard from '../components/StatCard';
import { platformIcons } from '../assets/assets/assets';
                      ...
                      <div className="flex items-center gap-2">
                        <div className='relative group'>
                          ...
                          <div className='invisible group-hover:visible absolute right-0 top-0 pt-4.5 z-10'>
                              <div className='bg-white text-gray-600 text-xs rounded border
                               border-gray-200 p-2 px-3'>
                                 ...
                                 <button className='text-nowrap'>
                                  ...
                                  ? listing.isCredentialChanged
                                  ? "Changed"
                                  : "Verified" : "Submitted" : "Not Submitted"}</span>
                                 </button>
                              </div>
                          </div>
                        </div>
