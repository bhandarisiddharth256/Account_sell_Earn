  ...
  return(
   <div class="max-w-5xl mx-2 md:mx-auto p-px rounded-2xl bg-gradient-to-r from-purple-600/20 to-blue-500/30">
    <div class="flex flex-col items-center justify-center text-center py-12 md:py-16 rounded-[15px] bg-gradient-to-r from-[#F3EAFF] to-[#E1EFFF]">  
        ...
        <p class="text-slate-500 mt-2 max-w-lg max-md:text-sm">We are the leading social media marketplace that connects with brands with their customer With our user friendly interface.</p>
