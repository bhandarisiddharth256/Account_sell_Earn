...
import { dummyChats } from '../assets/assets/assets';
...
const ChatBox = () => {
   ...
   const [isSending , setIsSending] = useState(false);
    ...
    <div className='fixed inset-0 bg-black/70 backdrop-blur bg-opacity-50 z-100 
        ...
        <div className='bg-white sm:rounded-lg shadow-2xl w-full max-w-2xl 
                        h-screen sm:h-[600px] flex flex-col'>

            {/* Header */}
            <div className='bg-linear-to-r from-indigo-600 to-indigo-400 
                            text-white p-4 sm:rounded-t-lg 
                ...
                >
                    ...
                    <textarea
                        ...
                        className="flex-1 resize-none border border-gray-300 rounded-lg px-4 py-2
                                focus:outline-indigo-500 max-h-32"
                        rows={1}
                    />
                    <button 
