      ...
      <div className="rethink relative flex flex-col items-center justify-center text-sm px-4 md:px-16 lg:px-24 xl:px-40 text-gray-800">
        ...
        <div className="flex items-center mt-24 md:mt-36">
          ...
          <div className="flex -space-x-3 pr-3">
            ...
            />
            <img
              src="https://images.unsplash.com/photo-1535713875002-d1d0cf377fdb?q=80&w=200"
              alt="user2"
              ...
              {Array(5)
                ...
                .map((_, i) => (
                  <svg
                    ...
                    aria-hidden="true"
                  >
                    <path d="M11.525 2.295a.53.53 0 0 1 .95 0l2.31 4.679a2.123 2.123 0 0 0 1.595 1.161l5.166.756a.53.53 0 0 1 .294.904l-3.736 3.638a2.123 2.123 0 0 0-.611 1.878l1.882 5.14a.53.53 0 0 1-.77.561l-4.618-2.428a2.122 2.122 0 0 0-1.973 0L6.396 21.01a.53.53 0 0 1-.77-.561l1.881-5.139a2.122 2.122 0 0 0-.611-1.879L2.16 9.795a.53.53 0 0 1 .294-.906l5.165-.755a2.122 2.122 0 0 0 1.597-1.16z"></path>
                  </svg>
                ))}
            </div>
