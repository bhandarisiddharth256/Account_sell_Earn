...
import { addCredential, addListing, getAllPublicListing, getAllUserListing, getAllUserOrders, markFeatured, purchaseAccount, togglestatus, updateListing, withdrawAmount } from "../controllers/listingController.js";
...
listingRouter.delete('/:listingId', protect , togglestatus);
